...
**Reference commit:** `ed29e0c7e1c2af3447ef041a799ed4efc0bbd0ec`
...
| Check | Result |
|---|---:|
| Automated Python tests | 231 passed in the v0.8.2 validation run |
...
Smart Crop is v0.8.3. Advanced layer features such as clipping masks, adjustment layers, and per-layer pixel operations are deferred until the layer model and pipeline model evolve together.
